...
/**
 * Registration Activity for SmartWorks App
 */
public class RegisterActivity extends AppCompatActivity {
        ...
        authManager.register(username, email, password)
            ...
            .exceptionally(throwable -> {
                runOnUiThread(() -> {
                    ...
                    Toast.makeText(this, "Registration failed: " + throwable.getMessage(), Toast.LENGTH_LONG).show();
                });
                return null;
            });
    }
    ...
    private void handleRegistrationError(String errorMessage) {
        if (errorMessage.toLowerCase().contains("username") && errorMessage.toLowerCase().contains("exists")) {
            etUsername.setError("Username already exists");
            etUsername.requestFocus();
        } else if (errorMessage.toLowerCase().contains("email") && errorMessage.toLowerCase().contains("exists")) {
